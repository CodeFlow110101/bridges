...
<body>
    <div class="container">
        <h1>Holiday Record</h1>

        <div class="section">
            <div class="section-title">HOLIDAY INFORMATION</div>
            <div class="info-grid">
                <div class="info-item">
        ...
        <div class="section">
            <div class="section-title">HOLIDAY DETAILS</div>
            <div class="info-grid">
                ...
                <div class="info-item full-width">
                    ...
                    <div class="info-value">
                        @if($record->date_of_upload)
                        {{ \Carbon\Carbon::parse($record->date_of_upload)->format('d-m-Y') }}
                        @else
                        N/A
                        @endif
                    </div>
