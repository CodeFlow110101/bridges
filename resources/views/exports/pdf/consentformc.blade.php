        ...
        <div class="section">
            ...
            <div class="info-grid">
                <div class="info-item full-width">
                    ...
                    <div class="info-value">{{ $record->organization_name ?? 'N/A' }}</div>
                </div>
                <div class="info-item full-width">
                    <div class="info-label">Organization Address</div>
                    <div class="info-value">{{ $record->organization_address ?? 'N/A' }}</div>
                </div>
                <div class="info-item">
                    <div class="info-label">Organization Email</div>
                    <div class="info-value">{{ $record->organization_email ?? 'N/A' }}</div>
                </div>
                <div class="info-item">
                    <div class="info-label">Organization Phone No</div>
                    <div class="info-value">{{ $record->organization_phone_no ?? 'N/A' }}</div>
                </div>
            </div>
        </div>
