    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    <div class="info-label">Location of Recording</div>
                    <div class="info-value">{{ $record->location_of_recording ?? 'N/A' }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="info-grid">
                <div class="info-item">
                    <div class="info-label">Date and Time of Signing</div>
                    <div class="info-value">{{ $record->date_and_time_of_signing ?? 'N/A' }}</div>
                </div>
                <div class="info-item">
