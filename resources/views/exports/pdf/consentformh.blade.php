...
<body>
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="info-grid">
                ...
                <div class="info-item full-width">
                    ...
                    <div class="info-value">{{ $record->address ?? 'N/A' }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            <div class="section-title">THERAPY TEAM INFORMATION</div>
            <div class="info-grid">
                <div class="info-item">
        ...
        <div class="signature-section" style="margin-top: 40px;">
            <div class="signature-box">
                ...
                @endif
                <strong>Individual Signature</strong>
            </div>
            <div class="signature-box">
